...
public class SplashScreen : MonoBehaviour {
		...
		void OnGUI()
		{
			...
			if (splashLogo != null)
			{
				...
				GUI.DrawTexture(splashLogoPos, splashLogo,ScaleMode.StretchToFill);
				//GUI.DrawTexture(new Rect(30,Screen.height/2,splashLogo.width,splashLogo.height), splashLogo,ScaleMode.StretchToFill);
				if (alpha > 1.0f)
				{
