...
namespace PreviewLabs
{
		public static class PlayerPrefs
		{
				...
				{
						if (!playerPrefsHashtable.ContainsKey (key)) {
								Debug.Log ("Data Added From if");
								playerPrefsHashtable.Add (key, value);
						} else {
								Debug.Log ("Data Added From else");
								playerPrefsHashtable [key] = value;
						}
				...
				{			
						if (playerPrefsHashtable.ContainsKey (key)) {
								...
								Debug.Log ("From GetString : " + playerPrefsHashtable [key].ToString ());
				...
				{
						Debug.Log ("if condition :" + playerPrefsHashtable.ContainsKey (key).ToString ());
						if (playerPrefsHashtable.ContainsKey (key)) {
								return playerPrefsHashtable [key].ToString ();
						} else {
				...
				{		
						...
						if (playerPrefsHashtable.ContainsKey (key)) {
								...
								Debug.Log ("From getINT : " + playerPrefsHashtable [key].ToString ());
				...
				public static int GetInt (string key, int defaultValue)
				{
						...
						if (playerPrefsHashtable.ContainsKey (key)) {
								...
								Debug.Log ("return " + defaultValue.ToString ());
								playerPrefsHashtable.Add (key, defaultValue);
								hashTableChanged = true;
								return defaultValue;
						}
